<?php
	...
	//通过php进行insert操作
	$sqlinsert="insert into capture_library_use_info (sample_library_m_id, fetch_date, fetch_person, return_date, return_person, usage_amount, rest_amount, remark) values('{$sample_library_m_id}','{$fetch_date}','{$fetch_person}','{$return_date}','{$return_person}','{$usage_amount}','{$rest_amount}','{$remark}')";
