<?php
	...
	//编号对应表insert操作
	$corrinsert="insert into sample_name_corresponding(sample_id,sample_rna_id) values('{$sample_id}','{$sample_rna_id}')";
	...
	if ($test == 1) {
		...
		echo "数据输入失败，请检查样本编号及样本RNA编号是否有误";
	}
...
?>
	...
	<form method="post" action="sample_rna_info_input.html">
