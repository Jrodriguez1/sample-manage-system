<?php
	...
	//通过php进行insert操作
	$sqlinsert="insert into dna_use_info (sample_dna_id, fetch_date, fetch_person, return_date, return_person, usage_amount, rest_amount, remark) values('{$sample_dna_id}','{$fetch_date}','{$fetch_person}','{$return_date}','{$return_person}','{$usage_amount}','{$rest_amount}','{$remark}')";
...
?>
	...
	<form method="post" action="dna_use_info_input.html">
